...
class _FlutterGameState extends State<FlutterGame> {
  ...
  Future<void> setup() async {
    ...
    Player player = Player(dash!.scene, dash.animations!, threeJs.camera,
        threeJs.globalKey, joystick);
...
class Coin {
  ...
  void update(three.Vector3 playerPosition, double dt) {
    ...
    if (collected) {
      ...
      object.position.y =
          startAnimPosition.y + math.sin(collectAnimation * 5) * 0.4;
      object.rotation.y *= 5;
    }
...
class Player {
  ...
  Player(this.object, this.animations, three.Camera camera,
